...
void Combat_simulator_config::get_combat_simulator_config(const T& input)
{
    ...
    combat.use_death_wish = String_helpers::find_string(input.options, "death_wish");
    ...
    combat.use_sweeping_strikes = String_helpers::find_string(input.options, "use_sweeping_strikes");
    ...
    combat.deep_wounds = String_helpers::find_string(input.options, "deep_wounds");
